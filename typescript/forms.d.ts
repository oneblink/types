...
export type FormElementEditableByApprovers = {
  /** Determine if this input can be edited by approvers (`true`) or not (`false`). */
  editableByApprovers?: boolean
}
...
export type FormElementWithOptionsBase = LookupFormElement &
  FormElementRequired &
  FormElementReadOnly &
  FormElementEditableByApprovers & {
    /**
...
export type ArcGISWebMapElement = {
  ...
  /**
   * The id of the basemap to be displayed to the user
  ...
  allowedDrawingTools?: {
    ...
    graphicAttributeOptions?: {
      ...
      id: string
      /**
       * Label shown in the list of options presented to the user and when
...
export type NewForm = WithCommonAssociations & {
  ...
  /**
   * The identifier for the email classification to apply to emails generated by
   * workflow events and approvals for this form. When unset, no data
