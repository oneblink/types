...
export type FormsAppJob = NewFormsAppJob & {
  ...
  id: string
  /**
   * @deprecated Use the presence of the `submissionId` property to determine if
   *   the job has been submitted. Will be `true` if the `submissionId` property
   *   has a value for backward compatibility.
   */
  isSubmitted: boolean
...
export type NewFormSubmissionMeta = {
  ...
  externalId?: string
  /**
   * The IP Address of the submitter of the Form. This cannot be trusted as the
   * submitter could change this.
   */
  ipAddress?: string
...
export type FormSubmissionAttachment = {
  s3: S3Configuration
  /**
   * @deprecated Use tenant origin with the `pathname` property to construct an
   *   absolute URL
   */
  url: string
  pathname: string
